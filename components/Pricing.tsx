         ...
         <div className="container mx-auto">
             ...
             <Tabs defaultValue="tab1">
                 <TabsList className="flex justify-center" aria-label="Manage your account">
                     <div className="flex justify-center gap-5 border rounded w-auto mb-10">
                         <TabsTrigger className="data-[state=active]:bg-blue-400 p-5 rounded text-gray-900" value="tab1">
                             Monthly
                         </TabsTrigger>
                         <TabsTrigger className="data-[state=active]:bg-blue-400 p-5 rounded text-gray-900" value="tab2">
                             Annually
                         </TabsTrigger>
                     </div>
                 </TabsList>
